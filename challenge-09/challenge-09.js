...
*/
console.log('O resultado da soma é:' + " " + sum((param1, param2) => param1 + param2));
// ?
...
let subtraction = calculator(5, 3);
let multiplication = calculator(2, 5);
let division = calculator(10, 5);
let subtramodction = calculator(5, 5);
...
chamada.
*/
console.log('O resultado da subtração é:' + " " + subtraction((param1, param2) => param1 - param2));
// ?

console.log('O resultado da multiplicação é:' + " " + multiplication((param1, param2) => param1 * param2));
// ?

console.log('O resultado da divisão é:' + " " + division((param1, param2) => param1 / param2));
// ?

console.log('O resto da divisão é:' + " " + subtramodction((param1, param2) => param1 % param2));
// ?
