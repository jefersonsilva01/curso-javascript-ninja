...
(function () {
  ...
  */
  ...
  console.log(text.replace(/Manuel Marques de Sousa/g, 'Jeferson dos Santos Silva'));
  /*
  ...
  */
  ...
  console.log("O mês de março é representado pelo número "
