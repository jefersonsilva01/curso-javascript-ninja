...
(function () {
  ...
  */
  ...
  var fred = new Person('Fred', 'Silva', 8);
  var bob = new Person('Bob', 'Silva', 2);
  var bela = new Person('Bela', 'Silva', 8);
  ...
  */
  ...
  console.log(fred.getFullName() + ' tem ' + fred.getAge() + ' anos.');
  console.log(bob.getFullName() + ' tem ' + bob.getAge() + ' anos.');
  console.log(bela.getFullName() + ' tem ' + bela.getAge() + ' anos.');
